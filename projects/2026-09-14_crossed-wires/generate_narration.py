#!/usr/bin/env python3
"""
Narration and Audio Pipeline for Crossed Wires — When Your Senses Bleed Into Each Other
...
SHOTS = [
    {
        "id": "shot_01",
        "name": "The Tasting Number",
        "text": "For one in every two thousand people, the number seven tastes like copper. Wednesday is salmon-colored. A G-major chord is bright orange."
    },
    {
        "id": "shot_02",
        "name": "The Crossed Board",
        "text": "In a typical brain, the visual cortex, the auditory cortex, and the gustatory cortex are separate neighborhoods. In synesthesia, the walls between them are thin — or missing entirely."
    },
    {
        "id": "shot_03",
        "name": "The Remapping Engine",
        "text": "Synesthesia isn't a disorder — it's a different wiring of the same hardware. The brain's pruning process simply left more connections alive than usual."
    },
    {
        "id": "shot_04",
        "name": "The Creativity Boost",
        "text": "Synesthetes are disproportionately represented among artists, musicians, and poets. Kandinsky heard colors. Pharrell tastes sounds. The crossed wires aren't noise — they're extra bandwidth."
    },
    {
        "id": "shot_05",
        "name": "The Universal Connection",
        "text": "Maybe synesthesia isn't the anomaly. Maybe it's a reminder that your senses were never meant to be separate — and that the world is richer than any single sense can capture."
    }
]
