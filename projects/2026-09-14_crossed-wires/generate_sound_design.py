...
def build_soundtrack():
    ...
    sfx_events = [
        ...
        # Shot 02
        ("tactile_click.wav", 9.55, -10),
        ("pen_draw.wav", 9.65, -11),
        ("switch_snap.wav", 14.50, -8),
        
        # Shot 03
        ("tactile_click.wav", 22.45, -10),
        ("pen_draw.wav", 22.55, -11),
        ("switch_snap.wav", 26.50, -8),
        
        # Shot 04
        ("tactile_click.wav", 32.40, -10),
        ("pen_draw.wav", 32.50, -11),
        ("switch_snap.wav", 38.00, -8),
        
        # Shot 05
        ("tactile_click.wav", 46.25, -10),
        ("switch_snap.wav", 46.35, -8),
        ("sub_swell.wav", 50.00, -12),
    ]
