#!/usr/bin/env python3
"""
Narration and Audio Pipeline for Change Blindness (The Illusion of Seeing Everything)
...
SHOTS = [
    {
        "id": "shot_01",
        "name": "The Door Experiment",
        "text": "You're giving directions to a stranger on the sidewalk, when two workers carry a wooden door right between you—swapping the person with a total stranger."
    },
    {
        "id": "shot_02",
        "name": "The Blind Conversation",
        "text": "Over half of all people never notice—continuing the conversation for minutes without realizing they are talking to an entirely new face."
    },
    {
        "id": "shot_03",
        "name": "The 2-Degree Fovea",
        "text": "Your eyes don't record a high-definition world. Razor-sharp vision is confined to just two tiny degrees at the center—the width of your thumbnail at arm's length."
    },
    {
        "id": "shot_04",
        "name": "The Neural Reconstruction",
        "text": "Everything outside that narrow spotlight is a low-resolution prediction, continuously filled in by memory and expectation."
    },
    {
        "id": "shot_05",
        "name": "The Minimal Summary",
        "text": "You don't see reality as it exists—you see a fleeting summary of what your brain assumes is still there."
    }
]
