...
def build_soundtrack():
    ...
    # Tactile events mapped to change blindness shots
    sfx_events = [
        # Shot 01: The Door Experiment (0.00 - 9.62)
        ("tactile_click.wav", 0.05, -10),
        ("pen_draw.wav", 0.15, -12),
        ("switch_snap.wav", 4.20, -8), # door cuts the connection!
        
        # Shot 02: The Blind Conversation (9.62 - 18.60)
        ("tactile_click.wav", 9.67, -10),
        ("pen_draw.wav", 10.20, -11), # progress bar fills
        ("sub_swell.wav", 14.50, -12),
        
        # Shot 03: The 2-Degree Fovea (18.60 - 28.86)
        ("tactile_click.wav", 18.65, -10),
        ("pen_draw.wav", 19.10, -11), # fovea circle focuses
        ("tactile_click.wav", 23.50, -10), # thumbnail callout
        ("sub_swell.wav", 25.00, -12),
        
        # Shot 04: The Neural Reconstruction (28.86 - 37.04)
        ("tactile_click.wav", 28.90, -10),
        ("switch_snap.wav", 29.80, -8), # predictive hallucination mode
        ("pen_draw.wav", 32.50, -11),
        
        # Shot 05: The Minimal Summary (37.04 - 44.66)
        ("tactile_click.wav", 37.10, -10),
        ("switch_snap.wav", 38.20, -8),
