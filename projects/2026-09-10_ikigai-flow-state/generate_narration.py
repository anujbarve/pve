#!/usr/bin/env python3
"""
Narration and Audio Pipeline for Flow State — The Neuroscience of Disappearing
...
SHOTS = [
    {
        "id": "shot_01",
        "name": "The Vanishing Clock",
        "text": "You sit down to write at nine o'clock. You look up and it's two in the morning. Fourteen hundred minutes just evaporated — and you felt every second of it."
    },
    {
        "id": "shot_02",
        "name": "The Challenge-Skill Balance",
        "text": "Flow lives in a narrow channel: the task must be hard enough to demand everything you have, but not so hard it overwhelms you."
    },
    {
        "id": "shot_03",
        "name": "Transient Hypofrontality",
        "text": "During flow, your prefrontal cortex — the part that judges, worries, and narrates your life — goes quiet. The inner critic literally shuts up."
    },
    {
        "id": "shot_04",
        "name": "The Neurochemical Flood",
        "text": "Flow floods your brain with dopamine, norepinephrine, endorphins, anandamide, and serotonin — the five most powerful performance chemicals your body can produce."
    },
    {
        "id": "shot_05",
        "name": "The Ikigai Anchor",
        "text": "Flow isn't a productivity hack. It's the state where you stop performing your life — and start living it."
    }
]
