...
def build_soundtrack():
    ...
    sfx_events = [
        # Shot 01: The Vanishing Clock (0.00s - 10.58s)
        ("tactile_click.wav", 0.05, -10),
        ("pen_draw.wav", 0.15, -11),
        ("pen_draw.wav", 4.20, -11),
        ("sub_swell.wav", 7.50, -12),
        
        # Shot 02: The Challenge-Skill Balance (10.58s - 18.60s)
        ("tactile_click.wav", 10.65, -10),
        ("pen_draw.wav", 12.50, -11),
        ("switch_snap.wav", 15.50, -8),
        
        # Shot 03: Transient Hypofrontality (18.60s - 29.58s)
        ("tactile_click.wav", 18.70, -10),
        ("pen_draw.wav", 21.00, -11),
        ("switch_snap.wav", 24.50, -8),
        
        # Shot 04: The Neurochemical Flood (29.58s - 40.80s)
        ("tactile_click.wav", 29.65, -10),
        ("pen_draw.wav", 32.00, -11),
        ("sub_swell.wav", 36.50, -12),
        
        # Shot 05: The Ikigai Anchor (40.80s - 48.98s)
        ("tactile_click.wav", 40.85, -10),
        ("pen_draw.wav", 42.50, -11),
        ("sub_swell.wav", 45.00, -12),
    ]
