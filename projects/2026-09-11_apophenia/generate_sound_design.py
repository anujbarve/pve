...
def build_soundtrack():
    ...
    sfx_events = [
        # Shot 01: The Face in the Static (0.00s - 11.22s)
        ("tactile_click.wav", 0.05, -10),
        ("pen_draw.wav", 0.15, -11),
        ("pen_draw.wav", 4.50, -11),
        ("sub_swell.wav", 7.50, -12),
        
        # Shot 02: The Pattern Detection Machine (11.22s - 19.16s)
        ("tactile_click.wav", 11.30, -10),
        ("pen_draw.wav", 13.50, -11),
        ("switch_snap.wav", 16.50, -8),
        
        # Shot 03: The Pareidolia Engine (19.16s - 32.38s)
        ("tactile_click.wav", 19.25, -10),
        ("pen_draw.wav", 22.00, -11),
        ("switch_snap.wav", 27.00, -8),
        
        # Shot 04: The Conspiracy Spiral (32.38s - 43.44s)
        ("tactile_click.wav", 32.45, -10),
        ("pen_draw.wav", 34.50, -11),
        ("switch_snap.wav", 39.00, -8),
        
        # Shot 05: The Epistemic Humility (43.44s - 55.22s)
        ("tactile_click.wav", 43.50, -10),
        ("pen_draw.wav", 46.00, -11),
