#!/usr/bin/env python3
"""
Narration and Audio Pipeline for Apophenia — Your Brain's Addiction to False Patterns
...
SHOTS = [
    {
        "id": "shot_01",
        "name": "The Face in the Static",
        "text": "You stare at television static and see a face. It's not there — but your brain insists it is, with the same conviction it uses to recognize your own mother."
    },
    {
        "id": "shot_02",
        "name": "The Pattern Detection Machine",
        "text": "Your visual cortex is a pattern-matching machine so aggressive it would rather see a predator in the bushes fifty times wrong than miss it once."
    },
    {
        "id": "shot_03",
        "name": "The Pareidolia Engine",
        "text": "Pareidolia — seeing faces in toast, Jesus in water stains, meaning in randomness — isn't a bug. It's the same neural wiring that lets you recognize a friend across a crowded room."
    },
    {
        "id": "shot_04",
        "name": "The Conspiracy Spiral",
        "text": "Once your brain finds a pattern, it can't unsee it. Connect the dots hard enough and you'll find meaning between any two points — even if the dots are random."
    },
    {
        "id": "shot_05",
        "name": "The Epistemic Humility",
        "text": "The brain that sees patterns everywhere is the same brain that discovered fire, built civilizations, and wrote symphonies. The price of genius is a little bit of beautiful madness."
    }
]
