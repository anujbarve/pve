#!/usr/bin/env python3
"""
Narration and Audio Pipeline for Network Priming — How One Word Activates Your Mental Web
...
SHOTS = [
    {
        "id": "shot_01",
        "name": "The Flash Word",
        "text": "You see the word 'doctor' for three hundred milliseconds. You don't even consciously register it. But your brain already knows what's coming next."
    },
    {
        "id": "shot_02",
        "name": "The Spreading Activation",
        "text": "One word triggers a cascade. 'Doctor' activates 'nurse,' which activates 'hospital,' which activates 'ambulance,' which activates 'emergency.'"
    },
    {
        "id": "shot_03",
        "name": "The Semantic Distance Map",
        "text": "Words closer in meaning activate faster. 'Nurse' lights up almost instantly after 'doctor.' 'Butterfly' takes longer. Your brain has a map — and proximity is measured in meaning, not spelling."
    },
    {
        "id": "shot_04",
        "name": "The Implicit Bias Machine",
        "text": "Priming doesn't just affect word recognition. Primed with 'old,' people walk slower. Primed with 'achievement,' they perform better on tests. Your behavior follows the network."
    },
    {
        "id": "shot_05",
        "name": "The Awareness",
        "text": "You are not the author of every thought you have. Some thoughts were placed there by the last word you read, the last image you saw, the last conversation you overheard."
    }
]
