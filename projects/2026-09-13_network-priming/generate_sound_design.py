...
- Prominent Tactile SFX: Crisp mechanical switch snaps (-8 dB), pen clicks (-10 dB), line draws (-11 dB), sub swells (-12 dB)
"""
...
def synth_sfx_library():
    ...
    # 1. Crisp Mechanical Switch Snap (-8 dB target)
    ...
    # 2. Prominent Drafting Pen Click (-10 dB target)
    ...
    # 3. Pen/Chalk Line Draw Friction (-11 dB target)
    ...
    # 4. Deep Grounding Sub-Swell (-12 dB target)
...
def synth_meditative_bgm():
    print("Synthesizing meditative ambient piano score...")
...
def build_soundtrack():
    ...
    # Tactical SFX placement aligned with shots:
    # Shot 01: 0.00 - 9.38
    # Shot 02: 9.38 - 20.76
    # Shot 03: 20.76 - 35.98
    # Shot 04: 35.98 - 50.32
    ...
    sfx_events = [
        ...
        ("pen_draw.wav", 0.15, -11),
        ("tactile_click.wav", 4.20, -10),
        
        # Shot 02
        ("tactile_click.wav", 9.45, -10),
        ("pen_draw.wav", 9.55, -11),
        ("switch_snap.wav", 14.50, -8),
        
        # Shot 03
        ("tactile_click.wav", 20.85, -10),
        ("pen_draw.wav", 21.00, -11),
        ("switch_snap.wav", 27.00, -8),
        
        # Shot 04
        ("tactile_click.wav", 36.05, -10),
        ("pen_draw.wav", 36.20, -11),
        ("switch_snap.wav", 42.50, -8),
        
        # Shot 05
        ("tactile_click.wav", 50.40, -10),
        ("switch_snap.wav", 50.50, -8),
        ("sub_swell.wav", 54.00, -12),
    ]
    ...
    bgm_gain = 10 ** (-19.0 / 20.0)  # -19 dB = ~0.1122
