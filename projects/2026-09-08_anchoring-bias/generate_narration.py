#!/usr/bin/env python3
"""
Narration and Audio Pipeline for Anchoring Bias — The First Number Hijacks Everything
...
SHOTS = [
    {
        "id": "shot_01",
        "name": "The Number Drop",
        "text": "A stranger tells you the number sixty-five. It seems random, meaningless — just a number floating in the air."
    },
    {
        "id": "shot_02",
        "name": "The Judgment Warp",
        "text": "Minutes later, you're asked to estimate something completely unrelated — and your answer is anchored to that random number like a ship tied to the ocean floor."
    },
    {
        "id": "shot_03",
        "name": "The Neural Mechanism",
        "text": "Your brain doesn't reset between questions. It takes whatever number is most recent and uses it as the starting line for every estimate that follows."
    },
    {
        "id": "shot_04",
        "name": "The Real-World Damage",
        "text": "Negotiate a salary, and the first number on the table sets the entire range. Your dream salary becomes a negotiation against someone else's anchor."
    },
    {
        "id": "shot_05",
        "name": "The Liberation",
        "text": "The anchor isn't magic — it's a shortcut. Knowing it exists is the first step to cutting the chain."
    }
]
