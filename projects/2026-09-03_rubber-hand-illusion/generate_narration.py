#!/usr/bin/env python3
"""
Narration and Audio Pipeline for The Rubber Hand Illusion (Body Ownership Plasticity)
...
SHOTS = [
    {
        "id": "shot_01",
        "name": "The Sensory Decoupling",
        "text": "You place your left hand behind an opaque screen, while a lifelike rubber hand rests in plain view directly on the table before you."
    },
    {
        "id": "shot_02",
        "name": "The Synchronous Tactile Binding",
        "text": "Two paintbrushes stroke both hands in exact, millisecond synchrony—what your eyes see and what your skin feels fuse into a single neural event."
    },
    {
        "id": "shot_03",
        "name": "Body Ownership Plasticity",
        "text": "In less than sixty seconds, your brain rewrites its body schema—severing ownership of your real flesh and adopting cold rubber as living biology."
    },
    {
        "id": "shot_04",
        "name": "The Threat Reflex",
        "text": "When a hammer suddenly smashes the fake hand, your nervous system fires in visceral terror—your heart spikes, defending the rubber with genuine pain reflexes."
    },
    {
        "id": "shot_05",
        "name": "The Fragility of Self",
        "text": "Your physical body is not a fixed anatomical fact—it is a fragile, real-time prediction that your brain can rewrite in a single minute."
    }
]
