...
def build_soundtrack():
    ...
    sfx_events = [
        # Shot 01: The Sensory Decoupling (0.0s - 8.74s)
        ("tactile_click.wav", 0.05, -10),
        ("pen_draw.wav", 0.10, -11),
        ("tactile_click.wav", 4.00, -10),
        
        # Shot 02: Synchronous Tactile Binding (8.74s - 18.60s)
        ("tactile_click.wav", 8.80, -10),
        ("pen_draw.wav", 9.20, -11),
        ("pen_draw.wav", 12.50, -11),
        ("sub_swell.wav", 14.00, -12),
        
        # Shot 03: Body Ownership Plasticity (18.60s - 28.46s)
        ("tactile_click.wav", 18.65, -10),
        ("switch_snap.wav", 22.50, -8),
        ("sub_swell.wav", 24.00, -12),
        
        # Shot 04: The Threat Reflex (28.46s - 39.92s)
        ("tactile_click.wav", 28.50, -10),
        ("switch_snap.wav", 31.50, -8),
        ("sub_swell.wav", 33.00, -12),
        
        # Shot 05: The Fragility of Self (39.92s - 48.90s)
        ("tactile_click.wav", 39.95, -10),
        ("pen_draw.wav", 40.50, -11),
        ("sub_swell.wav", 43.00, -12),
    ]
