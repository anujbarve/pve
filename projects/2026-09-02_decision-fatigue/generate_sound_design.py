...
def build_soundtrack():
    ...
    sfx_events = [
        # Shot 01: The Nighttime Paralysis (0.0s - 10.58s)
        ("tactile_click.wav", 0.05, -10),
        ("pen_draw.wav", 0.10, -11),
        ("tactile_click.wav", 5.20, -10),
        
        # Shot 02: The Neural Fuel Tank (10.58s - 21.16s)
        ("tactile_click.wav", 10.65, -10),
        ("pen_draw.wav", 11.00, -11),
        ("sub_swell.wav", 15.50, -12),
        
        # Shot 03: The Cognitive Downshift (21.16s - 31.74s)
        ("tactile_click.wav", 21.20, -10),
        ("switch_snap.wav", 24.50, -8),
        
        # Shot 04: The Default Trap (31.74s - 44.72s)
        ("tactile_click.wav", 31.80, -10),
        ("pen_draw.wav", 32.20, -11),
        ("switch_snap.wav", 37.50, -8),
        ("sub_swell.wav", 40.00, -12),
        
        # Shot 05: The Shield of Routine (44.72s - 53.62s)
        ("tactile_click.wav", 44.75, -10),
        ("pen_draw.wav", 45.20, -11),
        ("sub_swell.wav", 48.00, -12),
    ]
