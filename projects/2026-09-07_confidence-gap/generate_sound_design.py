...
def build_soundtrack():
    ...
    # Tactile events mapped to confidence gap shots
    sfx_events = [
        # Shot 01: The False Summit (0.00 - 8.66)
        ("tactile_click.wav", 0.05, -10),
        ("pen_draw.wav", 0.15, -12),
        ("sub_swell.wav", 4.20, -12),
        
        # Shot 02: The Valley of Despair (8.66 - 17.40)
        ("tactile_click.wav", 8.70, -10),
        ("switch_snap.wav", 9.20, -8), # confidence collapse!
        ("sub_swell.wav", 13.00, -12),
        
        # Shot 03: The Slope of Enlightenment (17.40 - 26.14)
        ("tactile_click.wav", 17.45, -10),
        ("pen_draw.wav", 18.00, -11), # stepped climb
        ("tactile_click.wav", 21.00, -10),
        
        # Shot 04: The Plateau of Sustainability (26.14 - 35.52)
        ("tactile_click.wav", 26.20, -10),
        ("pen_draw.wav", 26.80, -11),
        ("sub_swell.wav", 30.50, -12),
        
        # Shot 05: The Knowledge Paradox (35.52 - 44.26)
        ("tactile_click.wav", 35.60, -10),
        ("switch_snap.wav", 36.50, -8),
        ("sub_swell.wav", 39.50, -12),
    ]
