#!/usr/bin/env python3
"""
Narration and Audio Pipeline for The Confidence Gap (The Dunning-Kruger Effect)
...
SHOTS = [
    {
        ...
        "text": "A little knowledge is a dangerous thing—the moment you learn the basics, your confidence explodes into blind certainty."
    },
    {
        "id": "shot_02",
        "name": "The Valley of Despair",
        "text": "Then you see the true scale of the mountain, and the ground collapses beneath you—confidence plummets into the valley of despair."
    },
    {
        "id": "shot_03",
        "name": "The Slope of Enlightenment",
        "text": "The climb out is slow, humbling, and earned one mistake at a time—replacing borrowed certainty with real understanding."
    },
    {
        "id": "shot_04",
        "name": "The Plateau of Sustainability",
        "text": "At true expertise, something paradoxical happens—the higher you climb, the more you realize how vast the unknown remains."
    },
    {
        "id": "shot_05",
        "name": "The Knowledge Paradox",
        "text": "Ignorance breeds certainty; expertise breeds humility—the gap isn't your intelligence, it's knowing what you don't know."
    }
]
