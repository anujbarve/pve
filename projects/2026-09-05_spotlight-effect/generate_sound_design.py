...
def build_soundtrack():
    ...
    sfx_events = [
        # Shot 01: The 10,000-Watt Stain (0.00 - 9.62)
        ("tactile_click.wav", 0.05, -10),
        ("pen_draw.wav", 0.15, -12),
        ("sub_swell.wav", 4.50, -12),
        
        # Shot 02: The Hallucinated Audience (9.62 - 17.64)
        ("tactile_click.wav", 9.67, -10),
        ("pen_draw.wav", 9.80, -11),
        ("tactile_click.wav", 13.20, -10),
        
        # Shot 03: The Barry Manilow Test (17.64 - 28.70)
        ("tactile_click.wav", 17.70, -10),
        ("pen_draw.wav", 18.00, -11),
        ("pen_draw.wav", 23.50, -11),
        ("sub_swell.wav", 24.50, -12),
        
        # Shot 04: The Inward Vectors (28.70 - 37.84)
        ("tactile_click.wav", 28.75, -10),
        ("switch_snap.wav", 29.10, -8),
        ("sub_swell.wav", 33.00, -12),
        
        # Shot 05: The Blackout of Judgment (37.84 - 46.42)
        ("tactile_click.wav", 37.90, -10),
        ("switch_snap.wav", 38.80, -8),
        ("sub_swell.wav", 41.50, -12),
    ]
