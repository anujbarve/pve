...
def build_soundtrack():
    ...
    sfx_events = [
        # Diagram 01: Voice vs Reality
        ("tactile_click.wav", 0.05, -10),
        ("pen_draw.wav", 0.10, -12),
        ("tactile_click.wav", 1.80, -10),
        
        # Diagram 02: Comparison Illusion
        ("tactile_click.wav", 6.16, -10),
        ("pen_draw.wav", 6.25, -12),
        
        # Diagram 03: Dissociation / Not Laziness
        ("tactile_click.wav", 12.80, -10),
        ("pen_draw.wav", 15.92, -11), # strike line draw
        
        # Diagram 04: Tachometer Redline
        ("tactile_click.wav", 19.80, -10),
        ("pen_draw.wav", 20.30, -11), # needle climbing
        ("sub_swell.wav", 23.50, -13),
        
        # Diagram 05: Circuit Breaker Switch Snap (High prominence!)
        ("tactile_click.wav", 26.80, -10),
        ("switch_snap.wav", 28.00, -8), # prominent electrical switch snap!
        
        # Diagram 06: Worth != Output
        ("tactile_click.wav", 34.40, -10),
        ("sub_swell.wav", 34.80, -12),
        
        # Diagram 07: Ceasefire
        ("tactile_click.wav", 43.04, -10),
        ("pen_draw.wav", 44.50, -11), # arrows rotating into alignment
        ("sub_swell.wav", 46.00, -12),
    ]
