#!/usr/bin/env python3
"""
Narration and Voiceover Pipeline for Emotional Redlining
Archetype: Grounded Older Brother / Late-Night Realist
Step 1: TTS Synthesis via pocket-tts (conversational natural temperature 0.7)
...
SHOTS = [
    {
        "id": "shot_01",
        "name": "The Gut-Punch Hook",
        "text": "Most people don't hate their lives. They hate the voice in their head that never shuts up."
    },
    {
        "id": "shot_02",
        "name": "The Reality Check",
        "text": "You’ve been beating the hell out of yourself for weeks because you think you're falling behind everyone you know. You feel like a ghost in your own routine."
    },
    {
        "id": "shot_03",
        "name": "The Mechanism",
        "text": "Here’s what psychology actually calls this: it’s not laziness, it’s emotional redlining. When you spend months masking stress and carrying unspoken weight, your brain forcibly shuts down your motivation to protect your engine from blowing up."
    },
    {
        "id": "shot_04",
        "name": "The Guilt Release",
        "text": "Your worth isn't tied to your productivity today. You don't have to prove you deserve to exist every twenty-four hours."
    },
    {
        "id": "shot_05",
        "name": "The Anchor and Rebuild",
        "text": "Stop fighting yourself. You're doing better than you give yourself credit for. Close your eyes, get some sleep, and reset tomorrow. You've got this."
    }
]
...
def generate_tts():
    ...
    for shot in SHOTS:
        ...
        # Add 0.25s pre-roll and 0.35s tail pad for clean breathing space
        cmd_pad = [
            "ffmpeg", "-y", "-i", raw_path,
            "-af", "adelay=250|250,apad=pad_dur=0.35",
            "-ar", "24000", "-ac", "1",
            padded_path
        ]
