...
def build_soundtrack():
    ...
    sfx_events = [
        # Shot 01: The Phantom Pocket (0.0s - 8.10s)
        ("tactile_click.wav", 0.05, -10),
        ("pen_draw.wav", 0.10, -11),
        ("sub_swell.wav", 3.50, -12),
        
        # Shot 02: The Cognitive Amputation (8.10s - 16.36s)
        ("tactile_click.wav", 8.15, -10),
        ("switch_snap.wav", 11.20, -8),
        
        # Shot 03: The Extended Mind Thesis (16.36s - 25.90s)
        ("tactile_click.wav", 16.40, -10),
        ("pen_draw.wav", 17.00, -11),
        ("sub_swell.wav", 20.80, -12),
        
        # Shot 04: The Silicon Loop (25.90s - 34.16s)
        ("tactile_click.wav", 25.95, -10),
        ("pen_draw.wav", 26.50, -11),
        ("tactile_click.wav", 29.80, -10),
        
        # Shot 05: The Handheld Cyborg (34.16s - 42.26s)
        ("tactile_click.wav", 34.20, -10),
        ("sub_swell.wav", 35.50, -12),
        ("tactile_click.wav", 38.50, -10),
    ]
