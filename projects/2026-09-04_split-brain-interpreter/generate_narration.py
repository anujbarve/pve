#!/usr/bin/env python3
"""
Narration and Audio Pipeline for The Left-Brain Interpreter (The Illusion of Reason)
Step 1: TTS Synthesis via pocket-tts with reference_clean.wav
Step 2: ffprobe duration measurement
Step 3: Padding (0.3s pre-roll, 0.4s tail) & Loudness Mastering (-14 LUFS)
"""
...
SHOTS = [
    {
        ...
        "text": "When neuroscientists flashed the word 'WALK' into a split-brain patient's isolated right hemisphere, the patient stood up and began walking."
    },
    {
        "id": "shot_02",
        "name": "The Severed Bridge",
        "text": "Because the neural bridge between hemispheres was severed, his verbal left brain had zero knowledge of the command."
    },
    {
        "id": "shot_03",
        "name": "The Soda Confabulation",
        "text": "Yet when asked why he stood up, he didn't say 'I don't know'—his left brain instantly confabulated: 'I wanted to get a soda.'"
    },
    {
        "id": "shot_04",
        "name": "The Left-Brain Interpreter",
        "text": "Michael Gazzaniga discovered the Left-Brain Interpreter—a relentless neural circuit that manufactures logical stories to explain actions it never commanded."
    },
    {
        "id": "shot_05",
        "name": "The Illusion of Reason",
        "text": "You believe you act because you reason—but most of the time, you reason simply to justify what your brain has already decided to do."
    }
]
