...
def build_soundtrack():
    ...
    sfx_events = [
        ...
        # Shot 02
        ("tactile_click.wav", 10.25, -10),
        ("pen_draw.wav", 10.35, -11),
        ("switch_snap.wav", 15.00, -8),
        
        # Shot 03
        ("tactile_click.wav", 22.50, -10),
        ("pen_draw.wav", 22.60, -11),
        ("sub_swell.wav", 26.50, -12),
        
        # Shot 04
        ("tactile_click.wav", 32.05, -10),
        ("pen_draw.wav", 32.15, -11),
        ("switch_snap.wav", 35.80, -8),
        
        # Shot 05
        ("tactile_click.wav", 41.50, -10),
        ("switch_snap.wav", 41.60, -8),
        ("sub_swell.wav", 44.00, -12),
    ]
