#!/usr/bin/env python3
"""
Narration and Audio Pipeline for The Sunk Cost Fallacy
...
SHOTS = [
    {
        "id": "shot_01",
        "name": "The Two-Hour Meal",
        "text": "You waited two hours. The food is terrible. You eat every bite anyway — not because it's good, but because you already invested the time."
    },
    {
        "id": "shot_02",
        "name": "The Investment Ledger",
        "text": "Every dollar, every hour, every effort you've already spent is gone. It's not coming back. But your brain keeps a running ledger — and it demands a return on investment."
    },
    {
        "id": "shot_03",
        "name": "The Concorde Trap",
        "text": "The British and French governments kept funding the Concorde for decades after it became economically irrational — because they'd already spent so much they couldn't stop."
    },
    {
        "id": "shot_04",
        "name": "The Escalation Ladder",
        "text": "The sunk cost fallacy doesn't just keep you in bad investments — it makes you pour more in, chasing the losses with increasing desperation."
    },
    {
        "id": "shot_05",
        "name": "The Walking Away",
        "text": "The money is gone. The time is gone. The only real choice is whether you waste tomorrow too."
    }
]
