...
def build_soundtrack():
    ...
    sfx_events = [
        # Shot 01: The Wall of Jars (0.0s - 10.98s)
        ("tactile_click.wav", 0.05, -10),
        ("pen_draw.wav", 0.15, -11),
        ("tactile_click.wav", 4.50, -10),
        ("pen_draw.wav", 7.50, -11),
        
        # Shot 02: The Decision Freeze (10.98s - 20.28s)
        ("tactile_click.wav", 11.05, -10),
        ("pen_draw.wav", 13.50, -11),
        ("switch_snap.wav", 17.20, -8),
        
        # Shot 03: The Opportunity Cost Machine (20.28s - 30.78s)
        ("tactile_click.wav", 20.35, -10),
        ("pen_draw.wav", 22.50, -11),
        ("sub_swell.wav", 27.50, -12),
        
        # Shot 04: Maximizers vs Satisficers (30.78s - 42.72s)
        ("tactile_click.wav", 30.85, -10),
        ("pen_draw.wav", 33.20, -11),
        ("switch_snap.wav", 38.50, -8),
        
        # Shot 05: The Liberation (42.72s - 49.38s)
        ("tactile_click.wav", 42.80, -10),
        ("pen_draw.wav", 44.50, -11),
