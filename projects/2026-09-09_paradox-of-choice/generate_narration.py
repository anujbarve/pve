#!/usr/bin/env python3
"""
Narration and Audio Pipeline for The Paradox of Choice
...
SHOTS = [
    {
        "id": "shot_01",
        "name": "The Wall of Jars",
        "text": "Two hundred jams on a wall. You taste thirty. You walk out with nothing. Meanwhile, someone who saw six jars bought two and felt perfectly satisfied."
    },
    {
        "id": "shot_02",
        "name": "The Decision Freeze",
        "text": "Barry Schwartz called it the paradox of choice. Past a certain point, more options don't increase satisfaction — they increase regret."
    },
    {
        "id": "shot_03",
        "name": "The Opportunity Cost Machine",
        "text": "Every option you choose means all the others become ghosts of what you didn't pick. Your brain runs a simulation of the road not taken — and it never stops."
    },
    {
        "id": "shot_04",
        "name": "Maximizers vs Satisficers",
        "text": "Maximizers chase the best possible option. Satisficers pick one that's good enough. Maximizers make more money, choose better — and are profoundly less happy."
    },
    {
        "id": "shot_05",
        "name": "The Liberation",
        "text": "The secret isn't finding the best option. It's choosing one and never looking back."
    }
]
